...
export async function GET(req: Request) {
  ...
  const url = buildServiceUrl(process.env.CONTENT_SERVICE_URL, `/collections${requestUrl.search}`)
...
export async function POST(req: Request) {
  const url = buildServiceUrl(process.env.CONTENT_SERVICE_URL, "/collections")
